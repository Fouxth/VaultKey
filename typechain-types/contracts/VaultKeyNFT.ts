...
export interface VaultKeyNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface VaultKeyNFT extends BaseContract {
  connect(runner?: ContractRunner | null): VaultKeyNFT;
  waitForDeployment(): Promise<this>;

  interface: VaultKeyNFTInterface;
  ...
  setMaxTokens: TypedContractMethod<
